function refererenceCopying() {
	...
	console.log("%c ** Numbers **", "font-size:20px; color:red; background:black");
	let age = 100;
	let ageCopy = age;
	console.log("age : " + age, "\nageCopy : " + ageCopy);
	...
	console.log("%c ** Strings **", "font-size:20px; color:red; background:black");
	let name = "karna98";
	let nameCopy = name;
	...
	console.log("%c ** Arrays **", "font-size:20px; color:red; background:black");
	...
	console.log("%c ** Objects **", "font-size:20px; color:red; background:black");
	...
	const objectPersonCopyNew = Object.assign({}, objectPerson, { name: "HungryGamer" });
	console.log("objectPerson :");
	console.table(objectPerson);
	...
	console.log("Creating copy of objectMan : objectManCopy = Object.assign({}, objectMan)");
